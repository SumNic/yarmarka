    ...
    <div className="homePage">
      ...
      <div className="homePage__info">
        <Card className="homePage__infoCard">
          ...
          <Paragraph>
            <strong>Товары, услуги</strong> — только для тех, кто уже живёт в родовом поместье и создаёт пространство любви на своей земле.
          </Paragraph>
          <Paragraph>
            <strong>Работа</strong> — доступно всем приверженцам идей о родовых поместьях, даже если вы пока только в пути к своей земле.
          </Paragraph>
        </Card>
      </div>
